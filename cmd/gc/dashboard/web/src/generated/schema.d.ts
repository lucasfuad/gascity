...
export interface components {
    schemas: {
        ...
        AgentConfigUpdatedPayload: {
            /** @description City the agent belongs to. */
            city_name: string;
            /** @description Opaque content hash of the agent definition after the mutation. Same value as the ETag response header. */
            etag: string;
            /**
             * @description Which write path produced the event: "create" for POST /full, "update" for PATCH /full.
             * @enum {string}
             */
            operation: "create" | "update";
            /** @description Qualified agent name (dir/base or base) — same shape used by GET /agent/{...}/full. */
