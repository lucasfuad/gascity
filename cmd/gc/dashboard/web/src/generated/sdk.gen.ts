 ...
 */
export const getV0CityByCityNameAgentByBaseFragments = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByBaseFragmentsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByBaseFragmentsResponses, GetV0CityByCityNameAgentByBaseFragmentsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{base}/fragments', ...options });

/**
 * Get v0 city by city name agent by base full
 */
export const getV0CityByCityNameAgentByBaseFull = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByBaseFullData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByBaseFullResponses, GetV0CityByCityNameAgentByBaseFullErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{base}/full', ...options });

/**
 * Patch v0 city by city name agent by base full
 */
export const patchV0CityByCityNameAgentByBaseFull = <ThrowOnError extends boolean = false>(options: Options<PatchV0CityByCityNameAgentByBaseFullData, ThrowOnError>) => (options.client ?? client).patch<PatchV0CityByCityNameAgentByBaseFullResponses, PatchV0CityByCityNameAgentByBaseFullErrors, ThrowOnError>({
 ...
 *
 * Fork-only create endpoint mirroring PATCH /full's editable shape. Returns the post-create AgentFullResponse plus ETag, so the Studio's create wizard can hand off to the edit surface without a follow-up GET.
 */
export const maestroCreateAgentFull = <ThrowOnError extends boolean = false>(options: Options<MaestroCreateAgentFullData, ThrowOnError>) => (options.client ?? client).post<MaestroCreateAgentFullResponses, MaestroCreateAgentFullErrors, ThrowOnError>({
    url: '/v0/city/{cityName}/agent/{base}/full',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const getV0CityByCityNameAgentByBasePromptTemplate = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByBasePromptTemplateData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByBasePromptTemplateResponses, GetV0CityByCityNameAgentByBasePromptTemplateErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{base}/prompt-template', ...options });

/**
 * Put v0 city by city name agent by base prompt template
 */
export const putV0CityByCityNameAgentByBasePromptTemplate = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentByBasePromptTemplateData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentByBasePromptTemplateResponses, PutV0CityByCityNameAgentByBasePromptTemplateErrors, ThrowOnError>({
 ...
 */
export const getV0CityByCityNameAgentByDirByBaseFragments = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByDirByBaseFragmentsData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByDirByBaseFragmentsResponses, GetV0CityByCityNameAgentByDirByBaseFragmentsErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{dir}/{base}/fragments', ...options });

/**
 * Get v0 city by city name agent by dir by base full
 */
export const getV0CityByCityNameAgentByDirByBaseFull = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByDirByBaseFullData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByDirByBaseFullResponses, GetV0CityByCityNameAgentByDirByBaseFullErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{dir}/{base}/full', ...options });

/**
 * Patch v0 city by city name agent by dir by base full
 */
export const patchV0CityByCityNameAgentByDirByBaseFull = <ThrowOnError extends boolean = false>(options: Options<PatchV0CityByCityNameAgentByDirByBaseFullData, ThrowOnError>) => (options.client ?? client).patch<PatchV0CityByCityNameAgentByDirByBaseFullResponses, PatchV0CityByCityNameAgentByDirByBaseFullErrors, ThrowOnError>({
 ...
 *
 * Rig-scoped variant of POST /agent/{base}/full.
 */
export const maestroCreateAgentFullQualified = <ThrowOnError extends boolean = false>(options: Options<MaestroCreateAgentFullQualifiedData, ThrowOnError>) => (options.client ?? client).post<MaestroCreateAgentFullQualifiedResponses, MaestroCreateAgentFullQualifiedErrors, ThrowOnError>({
    url: '/v0/city/{cityName}/agent/{dir}/{base}/full',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const getV0CityByCityNameAgentByDirByBasePromptTemplate = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameAgentByDirByBasePromptTemplateData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameAgentByDirByBasePromptTemplateResponses, GetV0CityByCityNameAgentByDirByBasePromptTemplateErrors, ThrowOnError>({ url: '/v0/city/{cityName}/agent/{dir}/{base}/prompt-template', ...options });

/**
 * Put v0 city by city name agent by dir by base prompt template
 */
export const putV0CityByCityNameAgentByDirByBasePromptTemplate = <ThrowOnError extends boolean = false>(options: Options<PutV0CityByCityNameAgentByDirByBasePromptTemplateData, ThrowOnError>) => (options.client ?? client).put<PutV0CityByCityNameAgentByDirByBasePromptTemplateResponses, PutV0CityByCityNameAgentByDirByBasePromptTemplateErrors, ThrowOnError>({
